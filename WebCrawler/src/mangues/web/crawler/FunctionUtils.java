...
{  
    ...
    private static String pat = "http://\\w+\\.[a-zA-Z]+\\.[a-zA-Z]+/\\w+/[0-9]+";  
    private static Pattern pattern = Pattern.compile(pat);  
     
    private static BufferedWriter writer = null;  
    private static String pathString="DevelopmentOfSoftware/web/webpai";
    /**  
     * 爬虫搜索深度  
     */
    ...
    public static boolean isloan(String url)  
    {  
    	String pat = "http://\\w+\\.iteye+\\.[a-zA-Z]+/\\w+/[0-9]+";
    ...
    {  
        ...
        {  
            ...
            {  
                ...
                file = new File("D:" + File.separator+pathString + path.toString());  
